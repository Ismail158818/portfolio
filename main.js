const data = {
    ar: {
        ...
        heroSummary: 'مطور ويب متكامل متمرس في بناء تطبيقات الويب المتكاملة من الواجهة الأمامية إلى الخلفية. متخصص في Laravel للBackend وHTML/CSS/JavaScript للFrontend. شغوف ببناء حلول متكاملة وفعالة.',
        heroBtn: 'شاهد أعمالي',
        aboutTitle: 'من أنا؟',
